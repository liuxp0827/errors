...
import (
	...
	"github.com/liuxp0827/errors/cmd/protoc-gen-go-errors/errors"
...
const (
	...
	errorCtxPackage = protogen.GoImportPath("github.com/liuxp0827/errors/errorctx")
)
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.QualifiedGoIdent(errorCtxPackage.Ident("errorctx"))
...
func genErrorsReason(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, enum *protogen.Enum) bool {
	...
	for _, v := range enum.Values {
		...
		eReasonCh := proto.GetExtension(v.Desc.Options(), errors.E_Ch)
		reasonCh := ""
		if r, ok := eReasonCh.(string); ok {
			reasonCh = r
		}
		eReason := proto.GetExtension(v.Desc.Options(), errors.E_En)
		reason := ""
		if r, ok := eReason.(string); ok {
			reason = r
		}
		err := &errorInfo{
